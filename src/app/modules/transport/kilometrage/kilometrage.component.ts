...
import { IKilometrage } from 'src/app/core/models/transport/kilometrage';
...
export class KilometrageComponent extends EditableListComponent {

  editModal = EditComponent;
  _automobileId: number;
  selectedSinistre: IKilometrage;
  modalData;
  fragment: string;
  ...
  constructor(public route: ActivatedRoute, protected titleservice: AppTitleService,protected modalService: NgbModal) {
    super(new ResourceScrollableHelper(new KilometrageFactory(),
    new QueryOptions(
      [
      ],
      [],
    ...
    titleservice.setTitle('kilometrage');
  ...
  onSetSelected(panne: IKilometrage = null) {
