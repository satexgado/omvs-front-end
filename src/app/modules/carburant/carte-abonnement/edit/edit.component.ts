...
import { CarteAbonnementCarburant, ICarteAbonnementCarburant } from 'src/app/core/models/carte-abonnement-carburant';
...
export class EditComponent extends BaseEditComponent  {
  heading = 'carte abonnement';
  @Input() item: ICarteAbonnementCarburant = new CarteAbonnementCarburant();
  ...
  constructor(
    ...
    super(new CarteAbonnementCarburantFactory(), cdRef, activeModal);
  }

  createFormGroup(item: ICarteAbonnementCarburant) {
    ...
    return this.formBuilder.group({
      ...
      'libelle': [item.libelle, Validators.required, CarteValidator.alreadyUsedNumberAbonnementValidator(item.libelle)],
      'id': [item.id]
    });
  }
}
